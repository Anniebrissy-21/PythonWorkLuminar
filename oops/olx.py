class Olx:
    ...
    def destroy(self,id=None,*args,**kwargs):
        rec=[veh for veh in self.vehicles if veh.get("id")==id][0]
        self.vehicles.remove(rec)
...
#print(obj.create(id=7,name="nano",year=2000,selling_price=2400,color="yellow",location="tvm"))
